...
export default {
  ...
  meteor: {
    ...
    $subscribe: { Time: [] }, // A helper function to get the current time
    currentTime() {
    ...
    TimeCursor() {
      // Here you can use Meteor reactive sources like cursors or reactive vars // as you would in a Blaze template helper
      return Time.find({}, { sort: { time: -1 } });
    }
  }
};
</script> 
